                ...
                @foreach($ciclos as $ciclo)
                    @if($ciclo->user_id === Auth::id()) 
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('ciclos.edit', $ciclo->id) }}" class="btn text-white" style="background-color: #9fa1f8;">
...
<div class="row d-flex justify-content-center">
    <a href="{{ route('ciclos.create') }}" class="btn text-white" style="background-color: #9fa1f8; width: 20%;">
