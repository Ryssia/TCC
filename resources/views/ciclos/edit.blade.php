    ...
    <div class="col d-flex justify-content-center align-items-center">
        <div class="card w-75 text-center">
            <div class="card-body">
                ...
                <div class="range">
                    <input type="range" name="fluxo" class="form-range" min="0" max="4" oninput="this.nextElementSibling.value = getFlow(this.value)" />
                ...
                <div class="range">
                    <input type="range" name="colica" class="form-range" min="0" max="4" oninput="this.nextElementSibling.value = getColic(this.value)" />
                    <output class="fw-bold" style="color:#a19d9f;">Regular</output>
                </div>
                <hr>
                <div class="mb-2 d-flex justify-content-center">
                ...
                <div class="range">
                    <input type="range" name="dor_cabeca" class="form-range" min="0" max="4" oninput="this.nextElementSibling.value = getPainHead(this.value)" />
                    <output class="fw-bold" style="color:#a19d9f;">Regular</output>
                </div>
                <div class="mb-2 d-flex justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="#f38ebd" class="bi bi-droplet-fill" viewBox="0 0 16 16">
